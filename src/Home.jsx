...
export default function Home() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 font-inter">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-6">
            <div className="space-y-2">
              <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 tracking-tight no-underline">
                Welcome back, <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{userName}</span>
              </h1>
              <p className="text-lg text-slate-500 font-medium no-underline">
                {formatDate(currentTime)} • {formatTime(currentTime)}
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-white/70 backdrop-blur-sm shadow-lg shadow-blue-500/10 flex items-center justify-center border border-white/20 ring-1 ring-slate-900/5">
                <span className="text-blue-600 font-bold text-lg no-underline">
                  {userName.charAt(0).toUpperCase()}
                </span>
              </div>
            </div>
            ...
            {allowedPanels.map((panel, index) => (
              ...
              >
                <div className="h-full rounded-3xl p-8 bg-white/60 backdrop-blur-sm shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 border border-white/20 ring-1 ring-slate-900/5 hover:ring-blue-500/20 flex flex-col overflow-hidden relative">
                  ...
                  <h3 className="text-xl font-bold text-slate-800 mb-2 relative z-10 no-underline">
                    {panel.name}
                  </h3>
                  <p className="text-sm text-slate-600 mb-6 leading-relaxed relative z-10 no-underline">{panel.description}</p>
                  <div className="mt-auto flex justify-between items-center relative z-10">
                    <span className="text-xs font-semibold px-3 py-2 rounded-xl bg-slate-100/80 text-slate-600 backdrop-blur-sm no-underline">
                      Access module
                    </span>
                    <div className="text-slate-400 group-hover:text-blue-500 transition-all duration-300 group-hover:translate-x-1">
                      <svg
          ...
          <footer className="mt-20 pt-8 border-t border-slate-200/60 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 backdrop-blur-sm border border-white/20 shadow-sm">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
              <p className="text-sm font-medium text-slate-600 no-underline">
                Lemon Logistics ERP • v2.5 • {new Date().getFullYear()}
              </p>
            </div>
          </footer>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 pb-28 font-inter">
      {/* Header */}
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-white/20 shadow-sm">
        <div className="px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="space-y-1">
              <h1 className="text-2xl font-bold text-slate-800 tracking-tight no-underline">
                Hello, <span className="text-blue-600">{userName}</span>
              </h1>
              <p className="text-sm text-slate-500 font-medium no-underline">
                {currentTime.toLocaleDateString("en-US", {
                  weekday: "short",
                  month: "short",
                  day: "numeric",
            ...
            <div className="flex items-center gap-3">
              <div className="text-sm font-bold text-slate-700 bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-2 shadow-lg shadow-blue-500/10 border border-white/20 no-underline">
                {formatTime(currentTime)}
              </div>
              <div className="w-10 h-10 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg shadow-blue-500/10 flex items-center justify-center border border-white/20">
                <span className="text-blue-600 font-bold text-sm no-underline">
                  {userName.charAt(0).toUpperCase()}
                </span>
              </div>
            </div>
      ...
      <main className="px-4 py-6">
        {/* Quick Stats */}
        <div className="mb-8">
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-lg shadow-slate-200/50 border border-white/20 ring-1 ring-slate-900/5">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-bold text-slate-800 mb-1 no-underline">Quick Access</h2>
                <p className="text-sm text-slate-600 no-underline">{allowedPanels.length} modules available</p>
              </div>
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
                <MdOutlineDashboard className="text-blue-600" size={24} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-slate-800 px-2 no-underline">Your Modules</h2>
          ...
          <div className="grid grid-cols-1 gap-4">
            {allowedPanels.map((panel, idx) => (
              <Link
                to={panel.path}
                key={idx}
                className="block no-underline active:scale-95 transition-all duration-300 focus:outline-none group"
              >
                <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-lg shadow-slate-200/50 border border-white/20 ring-1 ring-slate-900/5 group-hover:shadow-xl group-hover:shadow-blue-500/20 transition-all duration-300 group-active:shadow-md relative overflow-hidden">
                  {/* Subtle background pattern */}
                  <div className="absolute inset-0 bg-gradient-to-br from-white/40 to-transparent pointer-events-none"></div>
                  
                  <div className="flex
Here's the complete enhanced code with underlines removed and a much better mobile view design:
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 pb-28 font-inter">
      ...
      <main className="px-4 py-6">
              ...
              >
                <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-lg shadow-slate-200/50 border border-white/20 ring-1 ring-slate-900/5 group-hover:shadow-xl group-hover:shadow-blue-500/20 transition-all duration-300 group-active:shadow-md relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    <div
                      className={`w-14 h-14 rounded-2xl ${panel.color} flex items-center justify-center shadow-lg transition-transform duration-300 group-hover:scale-110 flex-shrink-0`}
                    >
                      <div className={panel.iconColor}>{panel.icon}</div>
                    </div>
                    
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-slate-800 mb-1 no-underline">
                        {panel.name}
                      </h3>
                      <p className="text-sm text-slate-600 leading-relaxed no-underline">
                        {panel.description}
                      </p>
                    </div>
                    
                    <div className="text-slate-400 group-hover:text-blue-500 transition-all duration-300 group-hover:translate-x-1 flex-shrink-0">
                      <svg
                        width="20"
                        height="20"
                        viewBox="0 0 24 24"
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 backdrop-blur-sm border border-white/20 shadow-sm">
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
            <p className="text-xs font-medium text-slate-600 no-underline">
              Lemon Logistics ERP v2.5
            </p>
          </div>
        </div>
      </main>
      ...
      <nav className="fixed bottom-4 left-4 right-4 z-50">
        <div className="bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl shadow-slate-900/20 ring-1 ring-slate-900/5 overflow-hidden">
          <div className="flex justify-around items-center p-2">
            {allowedNavItems.map((item, index) => (
              <Link
                to={item.path}
                key={index}
                className="flex-1 p-3 rounded-2xl text-slate-500 active:text-slate-700 transition-all duration-300 focus:outline-none hover:bg-white/60 active:scale-95 group no-underline flex flex-col items-center"
                aria-label={item.name}
              >
                <div className={`${item.iconColor} transition-all duration-300 group-hover:scale-110 mb-1`}>
                  {item.navIcon}
                </div>
                <span className="text-xs font-medium text-slate-600 group-hover:text-slate-800 transition-colors no-underline">
                  {item.name.split(' ')[0]}
                </span>
              </Link>
            ))}
